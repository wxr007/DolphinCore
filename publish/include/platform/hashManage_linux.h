...
*hash
*************************************************************/
#ifndef _HASH_MANAGE_LINUX_H__
#define _HASH_MANAGE_LINUX_H__
...
//
//template<>
//struct hash<uint64_t long>
//{
//    size_t operator()(uint64_t long __x) const
//    {
//        if (sizeof(__x) == sizeof(size_t))
//            return __x;
//        else
...
public:
    ...
    typedef hash_map< keyT, valueT, _HashFcn, _EqualKey >	hashmap;
...
public:
    ...
    typedef hash_multimap< keyT, valueT, _HashFcn, _EqualKey > mhashmap;
    //typedef typename mhashmap::value_type;
    ...
    typedef keyT	key;
    typedef valueT  value;
    typedef pair<const_iter, const_iter>	const_eiters;
    typedef pair<iter, iter>	eiters;
protected:
    mhashmap ets;
public:
    inline bool push(const keyT &key, valueT &value)
...
protected:
    ...
    e3 m_e3;
public:
    using zHashManagerBase<valueT,e1,lockT>::m_e1;
    typedef typename e1::key	e1key;
    typedef typename e2::key	e2key;
    typedef typename e3::key	e3key;
...
public:
    ...
    typedef typename e2::key e2key;
    typedef typename e3::key e3key;
    typedef typename e4::key e4key;
    typedef typename e5::key e5key;
    typedef typename e6::key e6key;
    inline bool addValue(valueT& e)
    {
        AILOCKT(*this);
        e1key k1 = e1::mhkey(e);
