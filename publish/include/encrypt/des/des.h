...
#define LOAD_DATA(s,R,S,u,t,E0,E1,tmp) \
	u=R^s[S  ]; \
	t=R^s[S+1]
#define LOAD_DATA_tmp(s,a,b,c,d,e,f) LOAD_DATA(s,a,b,c,d,e,f,g)

#define D_ENCRYPT(s,LL,R,S) {\
	LOAD_DATA_tmp(s,R,S,u,t,E0,E1); \
	t=ROTATE(t,4); \
	LL^=\
	(*sp)[0][(u>> 2L)&0x3f]^ \
	(*sp)[2][(u>>10L)&0x3f]^ \
