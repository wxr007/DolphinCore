...
//#define DES_encrypt1(data,ks1,enc){
	...
	if(enc)
	{
		for(i = 0; i < 32; i += 8)
		{
			D_ENCRYPT(s,l, r, i + 0); /*  1 */
			D_ENCRYPT(s,r, l, i + 2); /*  2 */
			D_ENCRYPT(s,l, r, i + 4); /*  3 */
			D_ENCRYPT(s,r, l, i + 6); /*  4 */
		}
	}
	else
	{
		for(i = 30; i > 0; i -= 8)
		{
			D_ENCRYPT(s,l, r, i - 0); /* 16 */
			D_ENCRYPT(s,r, l, i - 2); /* 15 */
			D_ENCRYPT(s,l, r, i - 4); /* 14 */
			D_ENCRYPT(s,r, l, i - 6); /* 13 */
		}
	}
...
// #endif
	...
	* inner loop */
	if(enc)
	{
		...
		D_ENCRYPT(s,r, l, 6); /*  4 */
		D_ENCRYPT(s,l, r, 8); /*  5 */
		D_ENCRYPT(s,r, l, 10); /*  6 */
		D_ENCRYPT(s,l, r, 12); /*  7 */
		D_ENCRYPT(s,r, l, 14); /*  8 */
		D_ENCRYPT(s,l, r, 16); /*  9 */
		D_ENCRYPT(s,r, l, 18); /*  10 */
		D_ENCRYPT(s,l, r, 20); /*  11 */
		D_ENCRYPT(s,r, l, 22); /*  12 */
		D_ENCRYPT(s,l, r, 24); /*  13 */
		D_ENCRYPT(s,r, l, 26); /*  14 */
		D_ENCRYPT(s,l, r, 28); /*  15 */
		D_ENCRYPT(s,r, l, 30); /*  16 */
#else
	...
	{
#ifdef DES_UNROLL
		D_ENCRYPT(s,l, r, 30); /* 16 */
		D_ENCRYPT(s,r, l, 28); /* 15 */
		D_ENCRYPT(s,l, r, 26); /* 14 */
		D_ENCRYPT(s,r, l, 24); /* 13 */
		D_ENCRYPT(s,l, r, 22); /* 12 */
		D_ENCRYPT(s,r, l, 20); /* 11 */
		D_ENCRYPT(s,l, r, 18); /* 10 */
		D_ENCRYPT(s,r, l, 16); /*  9 */
		D_ENCRYPT(s,l, r, 14); /*  8 */
		D_ENCRYPT(s,r, l, 12); /*  7 */
		D_ENCRYPT(s,l, r, 10); /*  6 */
		D_ENCRYPT(s,r, l, 8); /*  5 */
		D_ENCRYPT(s,l, r, 6); /*  4 */
		D_ENCRYPT(s,r, l, 4); /*  3 */
		D_ENCRYPT(s,l, r, 2); /*  2 */
...
void DES_random_key(DES_cblock *ret)
{
	do
	{
		for(unsigned int i = 0; i < sizeof(DES_cblock); i++)
			(*ret)[i] = (unsigned char)(255.0 * rand() / (RAND_MAX + 1.0));
